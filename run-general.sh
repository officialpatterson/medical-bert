...
python medicalbert/ --experiment_name bert-uncase-lr5e5B16-1-layers --train --eval --target readm_30d --classifier bert-general --learning_rate 0.000005 --num_layers 1 --epochs 3;
